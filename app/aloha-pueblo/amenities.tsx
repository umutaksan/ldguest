...
export default function AlohaPuebloAmenitiesScreen() {
    ...
    <View style={[styles.container, { paddingBottom: insets.bottom }]}>
      ...
      >
        <Text style={styles.description}>
          Our Aloha Pueblo Townhouse is equipped with everything you need for a comfortable stay. Here are the amenities available to you:
        </Text>
        ...
        <View style={styles.additionalInfo}>
          ...
          <Text style={styles.featureText}>• Access to community garden</Text>
          <Text style={styles.featureText}>• Terrace space</Text>
          <Text style={styles.featureText}>• Golf course proximity</Text>
        </View>
      </ScrollView>
    </View>
  );
