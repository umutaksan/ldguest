...
export default function AlohaPuebloLuggageScreen() {
  ...
  const storageOptions = [
    {
      id: 1,
      name: 'Stasher',
      description: 'Convenient luggage storage in Nueva Andalucía and Puerto Banús area.',
    ...
    },
    {
      ...
      description: 'Secure luggage storage near Puerto Banús with verified locations.',
    ...
    <View style={[styles.container, { paddingBottom: insets.bottom }]}>
      ...
      >
        <Text style={styles.description}>
          Need to store your luggage before check-in or after check-out? Here are reliable storage options near your Aloha Pueblo townhouse:
        </Text>
