...
export default function AlohaPuebloPhotosScreen() {
    ...
    <View style={[styles.container, { paddingBottom: insets.bottom }]}>
      ...
      >
        <Text style={styles.description}>
          Explore our beautiful Aloha Pueblo Townhouse through these photos. Tap on any image to view it in full size.
        </Text>
