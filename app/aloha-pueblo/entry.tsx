      ...
      >
        <View style={styles.section}>
          ...
          <Text style={styles.description}>
            Welcome to your Aloha Pueblo townhouse! Here are the entry instructions for Calle del Agua, Apartment 168.
            {'\n\n'}
          ...
          <View style={styles.codeSection}>
            ...
            <Text style={styles.codeText}>• Main Door: 345424#</Text>
            <Text style={styles.codeText}>• Cabinet Code: 290</Text>
          </View>
        </View>
