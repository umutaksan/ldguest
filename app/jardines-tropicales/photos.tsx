...
export default function JardinesTropicalesPhotosScreen() {
    ...
    <View style={[styles.container, { paddingBottom: insets.bottom }]}>
      ...
      >
        <Text style={styles.description}>
          Explore our beautiful Jardines Tropicales Puerto Banús apartment through these photos. Tap on any image to view it in full size.
        </Text>
