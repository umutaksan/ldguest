...
import { Wifi, Coffee, Bath, Thermometer, Wind, Tv, Leaf as Safe, Sofa, Utensils, Washer } from 'lucide-react-native';
    ...
    <View style={[styles.container, { paddingBottom: insets.bottom }]}>
      ...
      >
        <Text style={styles.description}>
          Our Jardines Tropicales Puerto Banús apartment is equipped with everything you need for a comfortable stay. Here are the amenities available to you:
        </Text>
        ...
        <View style={styles.additionalInfo}>
          ...
          <Text style={styles.featureText}>• Access to community swimming pool</Text>
        </View>
      </ScrollView>
    </View>
  );
