...
const styles = StyleSheet.create({
  ...
  description: {
    ...
    ...(theme.layout.isWeb && theme.layout.isDesktop && {
  keyImagesGrid: {
    flexDirection: theme.layout.isWeb && theme.layout.isDesktop ? 'row' : 'column',
  ...
  mainKeyImage: {
    width: theme.layout.isWeb && theme.layout.isDesktop ? '48%' : '100%',
    height: 300,
    borderRadius: theme.borderRadius.m,
    ...theme.shadows.small,
    ...(theme.layout.isWeb && theme.layout.isDesktop && {
  ...
  smallImagesContainer: {
    width: theme.layout.isWeb && theme.layout.isDesktop ? '48%' : '100%',
    flexDirection: theme.layout.isWeb && theme.layout.isDesktop ? 'column' : 'row',
    justifyContent: 'space-between',
    gap: theme.spacing.m,
    alignItems: 'center',
    ...(theme.layout.isWeb && theme.layout.isDesktop && {
  ...
  smallKeyImage: {
    width: theme.layout.isWeb && theme.layout.isDesktop ? '100%' : '48%',
    height: 140,
    borderRadius: theme.borderRadius.m,
    ...theme.shadows.small,
    ...(theme.layout.isWeb && theme.layout.isDesktop && {
