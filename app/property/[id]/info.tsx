    ...
    switch(id) {
      ...
      case '29051503': // Aloha Pueblo
        return [
          { 
            id: 1, 
            question: 'Does the townhouse have a garden?', 
            answer: 'Yes, the townhouse has a private garden area.'
          },
          { 
            id: 2, 
            question: 'Is there a pool?', 
            answer: 'Yes, there is a community pool available for residents.'
          },
          { 
            id: 3, 
            question: 'Are pets allowed?', 
          ...
          { 
            id: 5, 
            question: 'How many people can stay in the townhouse?', 
            answer: 'The townhouse can accommodate up to 4 people. Sleeping arrangements:\n• 1 bedroom with a double bed\n• 1 sofa bed in the living room'
          },
          { 
            id: 6, 
            question: 'Is there a discount for long-term stays?', 
          ...
          { 
            id: 8, 
            question: 'How far are the golf courses?', 
            answer: 'Aloha Golf Club is just 300 meters away, and several other golf courses are within 1-2 km.'
          },
          { 
            id: 9, 
            question: 'How can I get to the townhouse from the airport?', 
            answer: 'You can take a bus, Uber, or taxi to get to the townhouse.'
          },
          { 
            id: 10, 
            question: 'Is parking available?', 
            answer: 'Yes, the townhouse includes private parking.'
          }
        ];
      case '29051504': // Old Town
        return [
          { 
            id: 1, 
            question: 'How close is the apartment to the Old Town center?', 
            answer: 'The apartment is located right in the heart of Marbella Old Town.'
          },
          { 
            id: 2, 
            question: 'Is there parking available?', 
            answer: 'There is no private parking, but there are public parking options nearby.'
          },
          { 
            id: 3, 
            question: 'How far is the beach?', 
            answer: 'The beach is approximately 600 meters away, about an 8-minute walk.'
          },
          { 
            id: 4, 
            question: 'Are pets allowed?', 
          ...
          { 
            id: 6, 
            question: 'How many people can stay in the apartment?', 
            answer: 'The apartment can accommodate up to 6 people. Sleeping arrangements:\n• 3 bedrooms with double beds\n• 1 sofa bed in the living room'
          },
          { 
            id: 7, 
            question: 'Is there a discount for long-term stays?', 
          ...
          { 
            id: 8, 
            question: 'Is the area safe at night?', 
            answer: 'Yes, the Old Town area is very safe, even late at night.'
          },
          { 
            id: 9, 
            question: 'How far is public transport?', 
      ...
      default:
        return [
          { 
            id: 1, 
            question: 'Does the property have a balcony?', 
            answer: 'Please check the property description for details.'
          },
          { 
            id: 2, 
            question: 'Is there a pool?', 
