    ...
    switch(id) {
      case '29051504': // Old Town
        return [
          ...
          { id: 9, title: 'Fully equipped small appliances', icon: <Utensils size={24} color={theme.colors.primary} /> },
          { id: 10, title: 'Three balconies', icon: <Droplets size={24} color={theme.colors.primary} /> },
        ];
      case '29051502': // Seaview
        return [
          ...
          { id: 9, title: 'Fully equipped small appliances', icon: <Utensils size={24} color={theme.colors.primary} /> },
          { id: 10, title: 'Beachfront view', icon: <Droplets size={24} color={theme.colors.primary} /> },
          { id: 11, title: 'Swimming pool', icon: <Droplets size={24} color={theme.colors.primary} /> },
        ];
      case '29051503': // Aloha
        return [
          { id: 1, title: 'High-speed WiFi', icon: <Wifi size={24} color={theme.colors.primary} /> },
          ...
          { id: 8, title: '2 Sofa beds', icon: <Sofa size={24} color={theme.colors.primary} /> },
          { id: 9, title: 'Fully equipped small appliances', icon: <Utensils size={24} color={theme.colors.primary} /> },
          { id: 10, title: 'Garden & terrace', icon: <Droplets size={24} color={theme.colors.primary} /> },
          { id: 11, title: 'Swimming pool', icon: <Droplets size={24} color={theme.colors.primary} /> },
        ];
