            ...
            {id === '29051502' && (
              <View style={styles.additionalButtonsContainer}>
                <TouchableOpacity 
                  ...
                  onPress={handleOpenStreetParking}
                  activeOpacity={0.8}
                >
                  <Text style={styles.secondaryButtonText}>View Street Parking</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity 
                  ...
                  activeOpacity={0.8}
                >
                  <Text style={styles.secondaryButtonText}>View Parking Area</Text>
                </TouchableOpacity>
              </View>
            )}
          </View>
