...
import { Wifi, Coffee, Bath, Thermometer, Wind, Tv, Leaf as Safe, Sofa, Utensils, Washer, Droplets } from 'lucide-react-native';
import Animated, { FadeIn } from 'react-native-reanimated';

export default function SeaviewAmenitiesScreen() {
    ...
    <View style={[styles.container, { paddingBottom: insets.bottom }]}>
      ...
      >
        <Text style={styles.description}>
          Our Seaview Playa de Fontanilla apartment is equipped with everything you need for a comfortable stay. Here are the amenities available to you:
        </Text>
        ...
        <View style={styles.additionalInfo}>
          ...
          <Text style={styles.featureText}>• Direct beach access</Text>
          <Text style={styles.featureText}>• Sea views</Text>
          <Text style={styles.featureText}>• Bunk bed in second bedroom</Text>
        </View>
      </ScrollView>
    </View>
  );
