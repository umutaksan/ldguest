...
export default function SeaviewLuggageScreen() {
  ...
  const storageOptions = [
    {
      id: 1,
      name: 'Stasher',
      description: 'Convenient luggage storage in Marbella city center, perfect for your Seaview apartment location.',
    ...
    },
    {
      ...
      description: 'Secure luggage storage near Marbella center with verified locations.',
    ...
    <View style={[styles.container, { paddingBottom: insets.bottom }]}>
      ...
      >
        <Text style={styles.description}>
          Need to store your luggage before check-in or after check-out? Here are reliable storage options near your Seaview apartment in Marbella:
        </Text>
