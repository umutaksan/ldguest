...
export default function SeaviewCarRentalScreen() {
      ...
      >
        <Animated.View entering={FadeIn.duration(500)}>
          <View style={styles.mainContent}>
            <Text style={styles.title}>Explore Costa del Sol at Your Own Pace</Text>
            <Text style={styles.description}>
              Discover the freedom of exploring the beautiful Costa del Sol with your own rental car. From scenic coastal drives to mountain adventures, make the most of your stay at Seaview Fontanilla with a reliable vehicle from our trusted partner.
            </Text>
