...
export default function OldTownLuggageScreen() {
  ...
  const storageOptions = [
    {
      id: 1,
      name: 'Stasher',
      description: 'Convenient luggage storage in Marbella Old Town, perfect for your historic apartment location.',
    ...
    },
    {
      ...
      description: 'Secure luggage storage near Marbella Old Town with verified locations.',
    ...
    <View style={[styles.container, { paddingBottom: insets.bottom }]}>
      ...
      >
        <Text style={styles.description}>
          Need to store your luggage before check-in or after check-out? Here are reliable storage options near your Old Town apartment in Marbella:
        </Text>
