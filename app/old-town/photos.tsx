...
export default function OldTownPhotosScreen() {
    ...
    <View style={[styles.container, { paddingBottom: insets.bottom }]}>
      ...
      >
        <Text style={styles.description}>
          Explore our beautiful Marbella Old Town apartment through these photos. Tap on any image to view it in full size.
        </Text>
