      ...
      >
        <Animated.View entering={FadeIn.duration(500)}>
          <View style={styles.mainContent}>
            <Text style={styles.title}>Explore Marbella at Your Own Pace</Text>
            <Text style={styles.description}>
              Discover the freedom of exploring Costa del Sol with your own rental car. From scenic coastal drives to mountain adventures, make the most of your stay with a reliable vehicle from our trusted partner.
            </Text>
